...
--
-- The transactional outbox (I8, spec 09 SS9.4): a state change and its event commit together or
-- not at all. NOT partitioned (unlike stock_movements/audit_logs) - spec 08 SS8.8's partitioning
