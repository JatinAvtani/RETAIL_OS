...
-- One line_number per PO — the display/print ordering PDF generation needs a
...
-- receiving-flow bug silently over-crediting stock beyond what was ever ordered (the receiving
-- flow is responsible for getting this right; this constraint means a bug there fails loudly
