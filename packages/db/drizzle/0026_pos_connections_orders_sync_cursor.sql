...
--
-- 006-05 (plan.md Phase 2): the orders sync's cursor + incremental watermark. Advanced ONLY in the
-- same transaction as the order/line writes it gates — plan.md's own named top risk is "cursor
