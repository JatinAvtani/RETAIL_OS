...
--
-- 005-08's quarantine queue (spec 05 SS5.1.3): a sale line whose POS item can't be resolved to a
-- MenuItem. No FK to pos_items/sales_transactions - those tables don't exist yet (EPIC-006, not
